...
- Source digest: `0bfab5ec22b8facc`
...
| universal-ctags | ok | ctags --output-format=json --fields=+n -L build/code-cartographer/ctags-files.txt -f - | Indexed 302 symbols; top kinds: property=135, variable=56, constant=49, function=49, heading3=7 | build/code-cartographer/ctags-files.txt |
| tokei | ok | tokei --output json . --exclude 'docs/architecture/code-map*' | Code lines: 10266; top languages: JSON=5368, YAML=2862, JavaScript=956, TSX=538, CSS=343 |  |
| scc | ok | scc --format json --not-match '^docs/architecture/code\-map.*$' . | Complexity: 179; top languages: JSON=5368, CSV=976, JavaScript=956, TypeScript=644, CSS=343 |  |
| cloc | ok | cloc --json --quiet --vcs git --exclude-list-file build/code-cartographer/cloc-exclude.txt | Files: 39; code lines: 11538; top languages: JSON=5368, YAML=2862, CSV=976, JavaScript=955, TypeScript=644 |  |
...
| apps/web/scripts/catalog/sync-support.mjs | source | auth | JavaScript | 306 | array, atomicWriteJson, defaultExternalPaths, fetchAccessToken, fetchLiveMedia, flattenCategories, loadDatabaseFallbacks, parseOptionalLiveThumbnail | better-sqlite3, fast-xml-parser, node:fs, node:path |
| apps/web/scripts/catalog/sync-support.test.mjs | source | auth | JavaScript | 155 |  | better-sqlite3, node:assert, node:fs, node:os, node:path, node:test |
