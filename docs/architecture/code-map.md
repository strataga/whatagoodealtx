...
- Source digest: `db4d0480f90b5ad0`
...
| tokei | ok | tokei --output json . --exclude 'docs/architecture/code-map*' | Code lines: 10319; top languages: JSON=5368, YAML=2862, JavaScript=1009, TSX=538, CSS=343 |  |
| scc | ok | scc --format json --not-match '^docs/architecture/code\-map.*$' . | Complexity: 182; top languages: JSON=5368, JavaScript=1009, CSV=976, TypeScript=644, CSS=343 |  |
| cloc | ok | cloc --json --quiet --vcs git --exclude-list-file build/code-cartographer/cloc-exclude.txt | Files: 39; code lines: 11591; top languages: JSON=5368, YAML=2862, JavaScript=1008, CSV=976, TypeScript=644 |  |
...
| apps/web/scripts/catalog/catalog-core.mjs | source | support | JavaScript | 167 | REQUIRED_HEADERS, collapseCatalogRows, isUnexpired, listingUrlFor, parseCatalogCsv, parseEbayDateToIso, parseMoneyToCents, validateCurrency | csv-parse |
...
| apps/web/scripts/catalog/sync-support.test.mjs | source | auth | JavaScript | 192 |  | better-sqlite3, node:assert, node:fs, node:os, node:path, node:test |
