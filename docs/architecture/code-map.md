...
- Source digest: `45b3f698b160e167`
...
| universal-ctags | ok | ctags --output-format=json --fields=+n -L build/code-cartographer/ctags-files.txt -f - | Indexed 268 symbols; top kinds: property=118, variable=48, function=46, constant=43, heading3=7 | build/code-cartographer/ctags-files.txt |
| tokei | ok | tokei --output json . --exclude 'docs/architecture/code-map*' | Code lines: 10137; top languages: JSON=5368, YAML=2862, JavaScript=845, TSX=520, CSS=343 |  |
| scc | ok | scc --format json --not-match '^docs/architecture/code\-map.*$' . | Complexity: 170; top languages: JSON=5368, CSV=976, JavaScript=845, TypeScript=626, CSS=343 |  |
| cloc | ok | cloc --json --quiet --vcs git --exclude-list-file build/code-cartographer/cloc-exclude.txt | Files: 38; code lines: 11409; top languages: JSON=5368, YAML=2862, CSV=976, JavaScript=844, TypeScript=626 |  |
...
| apps/web/scripts/catalog/sync-support.mjs | source | auth | JavaScript | 264 | array, atomicWriteJson, defaultExternalPaths, fetchAccessToken, fetchLiveMedia, flattenCategories, loadDatabaseFallbacks, parseOptionalLiveThumbnail | better-sqlite3, fast-xml-parser, node:fs, node:path |
| apps/web/scripts/catalog/sync-support.test.mjs | source | auth | JavaScript | 78 |  | node:assert, node:fs, node:os, node:path, node:test |
